...
class DQNAgent:
    def __init__(self, state_size, action_size,  
                 hidden_size=64, gamma=0.99, lr=0.001, batch_size=64, 
                 memory_size=10000):
    ...
    def set_init_state(self, obs, memory_length):
        self.state = torch.stack([obs for _ in range(memory_length)], axis = 0)
